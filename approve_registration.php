...
if (isset($_GET['event_id'], $_GET['user_id'], $_GET['registration_id'])) {
    ...
    $sql = "UPDATE registrations SET status = 'approved' WHERE id = :registration_id AND event_id = :event_id AND user_id = :user_id";
    ...
    // อัปเดตจำนวนผู้ที่ได้รับอนุมัติใน event_statistics
